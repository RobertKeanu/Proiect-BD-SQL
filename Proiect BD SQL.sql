...
drop table Echipa;
drop table Slujba;
drop table Distinctie;
drop table Program_animatie;
drop table Tableta_grafica;
drop table Aparatura;
drop table Angajat;
drop table Utilizeaza;
drop table A_primit;

-----------------finish stergere tabele-------------------
...
insert into Filiala values(incrementare_cod_filiala.nextval,2,11,'Bulevardul Champs-Élysées','Da');
...
drop sequence incrementare_cod_filiala;
drop sequence incrementare_cod_echipa;
drop sequence incrementare_cod_slujba;
drop sequence incrementare_cod_distinctie;
drop sequence incrementare_cod_program_animatie;
drop sequence incrementare_cod_tableta_grafica;
drop sequence incrementare_cod_aparatura;
drop sequence incrementare_cod_angajat;
--------------------------------finish stergere secvente------------------------------
...
select * from Echipa;
select * from Slujba;
select * from Distinctie;
select * from Program_animatie;
select * from Tableta_grafica;
select * from Aparatura;
select * from Angajat;
select * from Utilizeaza;
select * from A_primit;
-------------------------finish info---------------------------------------
...
delete from Tara;
delete from Oras;
delete from Program_animatie;
delete from Tableta_grafica;
delete from Slujba;
delete from Distinctie;
delete from Aparatura;
delete from Utilizeaza;
delete from Filiala;
delete from Echipa;
delete from Angajat;
delete from A_primit;
------------------finish delete-------------------------------
